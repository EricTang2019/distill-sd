...
# Optional monkey patch: expose strict SD trace and target logprobs in SGLang outputs.
apply_waste_sd_patch()

# Optional monkey patch: keep draft model fixed for standalone speculative decoding.
...
class ServerAdapter(BaseRollout):
    ...
    async def update_weights(self, weights: Generator[tuple[str, torch.Tensor], None, None], **kwargs):
        ...
        update_weights_bucket_bytes = int(bucket_size_mb) << 20
