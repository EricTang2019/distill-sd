...
class TokenOutput(BaseModel):
    ...
    spec_accept_lens: Optional[list[int]] = None
    """accepted token lengths per SD block for strict waste-aware weighting"""
    spec_verify_ct: Optional[int] = None
    """number of speculative verify calls (approximately the number of SD blocks)"""
    spec_accepted_tokens: Optional[int] = None
    """number of accepted draft tokens across speculative verify calls"""
    weight_version: Optional[int] = None
    """weight version used by rollout engine when generating this sample"""
    target_forward_total_calls: Optional[int] = None
    """number of target forward calls observed for this request"""
    target_forward_verify_true_calls: Optional[int] = None
    """number of target forward calls with is_verify=True for this request"""
    target_forward_verify_false_calls: Optional[int] = None
    """number of target forward calls with is_verify=False for this request"""
    target_forward_verify_true_called: Optional[bool] = None
    """whether target forward was ever called with is_verify=True for this request"""
    verify_hook_calls: Optional[int] = None
    """number of verify-hook invocations observed for this request"""
