...
class Tracking:
    ...
    def close(self, exit_code: int = 0):
        """Best-effort shutdown for all logger backends."""
        if self._closed:
            return
        self._closed = True

        # Never let tracking teardown fail the main process shutdown path.
        try:
    ...
    def __del__(self):
        try:
            ...
            # Destructors run during interpreter teardown; suppress all cleanup errors.
            pass
