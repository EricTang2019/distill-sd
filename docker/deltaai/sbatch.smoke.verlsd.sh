#!/bin/bash
#SBATCH --job-name=verl-deltaai-verlsd-smoke
#SBATCH --nodes=1
...
SIF_PATH="${SIF_PATH:-/projects/<your-project>/containers/verl-deltaai-verlsd.sif}"
DELTAAI_PYTHONUSERBASE="${DELTAAI_PYTHONUSERBASE:-/scratch/$USER/verl-deltaai/verlsd-userbase}"
...
srun apptainer exec --nv \
  ...
  /opt/verl-deltaai/scripts/run_in_deltaai_env.sh verlsd "${REPO_ROOT}" -- \
